    ...
    return function ctAxisRight(chart) {
      ...
      chart.on('created', function (data) {
        ...
        if (data.axisY) {
          ...
          let space = data.axisY.chartRect.y1 / data.axisY.ticks.length + 1.2;
          let xPos = data.axisY.chartRect.x2 + 10; //data.options.chartPadding.right + data.axisX.axisLength; // options.axisY.offset.x + 45;
          let yPos = data.axisY.chartRect.y2 + 3; // data.options.chartPadding.top + /*data.options.axisX.offset; +*/ space * 1.20;
